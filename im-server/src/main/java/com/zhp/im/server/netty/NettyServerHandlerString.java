 ...
 * @date 2018/5/16.
 */
public class NettyServerHandlerString extends SimpleChannelInboundHandler<String> {
    private static final Logger log = org.apache.logging.log4j.LogManager.getLogger(NettyServerHandlerString.class);
    private IChannelController channelController;
    public NettyServerHandlerString bindChannelController(IChannelController iChannelController){
